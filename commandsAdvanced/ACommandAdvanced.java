...
/**
 * ACommandAdvanced is an abstract class that implements the IImageCommandAdvanced interface. This
 * class is written to implement the methods which are common to all the command classes.
 */
